...
<?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_admission_secretary_retrun_understand')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            id="documents_admission_secretary_retrunController_sub3_sealid">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group hide" id="documents_admission_secretary_retrunController_form-group_sub3_note">
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_secretary_retrun/detail.blade.php ENDPATH**/ ?>