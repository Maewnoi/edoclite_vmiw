                    ...
                    <div class="border shadow card border-info">
                        <div class="card-body table-responsive">
                            <ul class="flex-row nav nav-pills">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('reserve_number_delivery_all')); ?>" class="nav-link">
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/reserve_number_delivery_inside_all/index.blade.php ENDPATH**/ ?>