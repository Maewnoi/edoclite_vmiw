...
<?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_admission_inside_jurisprudence_understand')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route('documents_admission_inside_jurisprudence_do_not_understand')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                <div class="flex items-center justify-center">
                                    <input type="hidden" name="doc_id" value="<?php echo e($document_detail->doc_id); ?>">
                                    <input type="hidden" name="sub_id" value="<?php echo e($document_detail->sub_id); ?>">
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_inside_jurisprudence/detail.blade.php ENDPATH**/ ?>