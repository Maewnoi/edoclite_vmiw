...
<?php endif; ?>
                            ...
                            <?php elseif($document_detail->doc_status == 'success' && $check_s == '0'): ?>
        ...
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('documents_pending_updateGroupmem')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        <div class="card card-body">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['class' => 'text-lg','value' => ''.e(__('พิจารณาเลือกกองที่เกี่ยวข้อง')).'']]); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $GroupmemS_success; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_Groupmem_success): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($row_Groupmem_success->group_id); ?>">
                                        <?php echo e($row_Groupmem_success->group_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['sub_recid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_pending/detail.blade.php ENDPATH**/ ?>