...
<?php endif; ?>
                                            <div class="row">
                                                ...
                                                <!-- //บันทึกข้อความ -->
                                                <div class="form-group"
                                                    id="documents_admission_work_retrunController_form-group_tb-sub3_details-message-memo">
                                                    <page id="documents_admission_work_retrunController_page"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9">
                                                                <input class="mt-2 form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_government"
                                                            ...
                                                            <div class="col-4">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_draft"
                                                            ...
                                                            <div class="col-4">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_date"
                                                            ...
                                                            <div class="col-10">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_topic"
                                                                    name="sub3d_topic" type="text" value="<?php echo e($document_detail->sub3d_topic); ?>">
                                                            </div>
                                                            <!-- // -->
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_admission_work_retrunController_sub3d_podium" class="form-control" rows="25" cols="75"name="sub3d_podium"><?php echo e($document_detail->sub3d_podium); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
...
<?php endif; ?>
                                                ...
                                                <!-- ตราครุฑ -->
                                                <div class="form-group"
                                                    id="documents_admission_work_retrunController_form-group_tb-sub3_details-garuda">
                                                    <page id="documents_admission_work_retrunController_page"
                                                        class="items-center block p-24 mx-auto bg-white shadow-2xl">
                                                        <div class="row">
                                                            <div class="col-3 pt-14">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_draft-garuda"
                                                            ...
                                                            <div class="col-4 pt-14">
                                                                   <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_government-garuda"
                                                            ...
                                                            <div class="col-3">
                                                                <input class="mt-3 form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_date-garuda"
                                                            ...
                                                            <div class="col-10">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_admission_work_retrunController_sub3d_topic-garuda"
                                                                    name="sub3d_topic_garuda" type="text" value="<?php echo e($document_detail->sub3d_topic); ?>">
                                                            </div>   
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_admission_work_retrunController_sub3d_podium-garuda" class="form-control" rows="25" cols="75" name="sub3d_podium_garuda"><?php echo e($document_detail->sub3d_podium); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
...
<?php endif; ?>
                                                ...
                                                <?php elseif($document_detail->sub3_type == '2'): ?>
                                                <div class="form-group"
...
<?php endif; ?>
                                                                <input class="form-control"
                                                                    name="sub3d_government_normal" type="text" value="<?php echo e($document_detail->sub3d_government); ?>">
                                                        </div>
                                                        <div class="col-3">
                                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                                                <input class="form-control"
                                                                    name="sub3d_draft_normal" type="text" value="<?php echo e($document_detail->sub3d_draft); ?>">
                                                        </div>
                                                        <div class="col-3">
                                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                                                <input class="form-control"
                                                                    name="sub3d_date_normal" type="text" value="<?php echo e($document_detail->sub3d_date); ?>">
                                                        </div>
                                                        <div class="col-3">
                                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                                                <input class="form-control"
                                                                    name="sub3d_topic_normal" type="text" value="<?php echo e($document_detail->sub3d_topic); ?>">
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="doc_id_normal" value="<?php echo e($document_detail->doc_id); ?>">
                                                    <input type="hidden" name="sub3_id_normal" value="<?php echo e($document_detail->sub3_id); ?>">
                                                    <input type="hidden" name="sub3d_id_normal" value="<?php echo e($document_detail->sub3d_id); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <div class="flex items-center justify-center mt-20">
                                                        ...
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['onclick' => 'submitForm(this);','id' => 'documents_admission_work_retrun_bt_respond-normal','disabled' => true]]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['onclick' => 'submitForm(this);','id' => 'documents_admission_work_retrun_bt_respond-normal','disabled' => true]); ?>
                                                            <?php echo e(__('ตอบกลับอีกครั้ง')); ?>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="bg-indigo-300 modal-header">
                    ...
                    <button type="button"
                        id="documents_admission_work_retrunController_close-modal-preview">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="col-12">
                        <iframe id="documents_admission_work_retrunController_pdf_preview" frameborder="0" height="800px"
                            width="100%">
                        </iframe>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_work_retrun/detail.blade.php ENDPATH**/ ?>