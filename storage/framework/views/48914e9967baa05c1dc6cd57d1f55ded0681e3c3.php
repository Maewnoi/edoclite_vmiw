            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="border shadow card border-info">
                        <div class="card-header bg-primary">รายการจองเลขคำสั่งภายในทั้งหมด</div>
...
<?php endif; ?>
                                                ...
                                                <input type="hidden" id="auto_reserve_number_arn_template" value="order">
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/reserve_number_order_all/index.blade.php ENDPATH**/ ?>