...
<head>
    ...
    <!-- icon -->
    <link rel="apple-touch-icon" href="<?php echo e(asset('/image/icon.jpg')); ?>" />
    <link rel="icon" href="<?php echo asset('/image/icon.jpg'); ?>" />
    <!-- load -->
...
} elseif ($_instance->childHasBeenRendered('mrdflbm')) {
    $componentId = $_instance->getRenderedChildComponentId('mrdflbm');
    $componentTag = $_instance->getRenderedChildComponentTagName('mrdflbm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mrdflbm');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('mrdflbm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="<?php echo e(asset('/js/jsController.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\edoclite-lei\resources\views/layouts/app.blade.php ENDPATH**/ ?>