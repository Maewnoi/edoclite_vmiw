...
<?php endif; ?>
                            ...
                            <hr>
                            <?php if($document_retrun_inside_detail->docrt_status == '2'): ?>
                            <div class="row">
                                <div class="col-md-12">
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'docrt_sealid','value' => ''.e(__('เลือกผู้ลงนาม')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_retrun_inside_jurisprudence/detail.blade.php ENDPATH**/ ?>