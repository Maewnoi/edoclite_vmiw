...
<?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_admission_inside_minister_sign_understand')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                            required name="sub3_sealid" id="documents_admission_inside_minister_signController_sub3_sealid">
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_inside_minister_sign/detail.blade.php ENDPATH**/ ?>