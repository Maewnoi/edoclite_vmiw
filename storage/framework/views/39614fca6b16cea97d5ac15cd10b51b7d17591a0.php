                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body table-responsive">
                            <table id="example1" class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $document_admission_all_work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(url('/documents_admission_work_all/detail/'.$row->doc_id)).'']]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(url('/documents_admission_work_all/detail/'.$row->doc_id)).'']); ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_work_all/index.blade.php ENDPATH**/ ?>