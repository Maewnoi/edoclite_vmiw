<?php $attributes = $attributes->exceptProps(['title' => __('ยืนยันรหัสผ่าน'), 'content' => __('เพื่อความปลอดภัยของคุณ โปรดยืนยันรหัสผ่านเพื่อดำเนินการต่อ.'), 'button' => __('ยืนยัน')]); ?>
<?php foreach (array_filter((['title' => __('ยืนยันรหัสผ่าน'), 'content' => __('เพื่อความปลอดภัยของคุณ โปรดยืนยันรหัสผ่านเพื่อดำเนินการต่อ.'), 'button' => __('ยืนยัน')]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if (! $__env->hasRenderedOnce('99ab5cef-e56c-4333-8e6d-00ba024d57a6')): $__env->markAsRenderedOnce('99ab5cef-e56c-4333-8e6d-00ba024d57a6'); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite/vendor/laravel/jetstream/src/../resources/views/components/confirms-password.blade.php ENDPATH**/ ?>