...
<?php endif; ?>
                                <button type="button" data-toggle="modal"
                                    ...
                                    class="btn btn-outline-warning btn-sm col-md-1"><i class="fa fa-edit"></i></button>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
...
<?php endif; ?>
                                            <?php elseif($document_detail->doc_status == 'success'): ?>
                                                ...
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['class' => 'text-lg','value' => ''.e(__('กองงานที่เกี่ยวข้อง : ')).' '.e(functionController::funtion_groupmem_name($row_sub_docs->sub_recid)).'']]); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'text-lg','value' => ''.e(__('กองงานที่เกี่ยวข้อง : ')).' '.e(functionController::funtion_groupmem_name($row_sub_docs->sub_recid)).'']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite/resources/views/member/documents_admission_all/detail.blade.php ENDPATH**/ ?>