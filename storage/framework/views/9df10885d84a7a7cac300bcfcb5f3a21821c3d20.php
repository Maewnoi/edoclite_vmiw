...
<?php endif; ?>
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_retrun_inside_division_retrun_respond')); ?>" method="post"
...
<?php endif; ?>
                                            <div class="row">
                                                ...
                                                <!-- //บันทึกข้อความ -->
                                                <div class="form-group"
                                                    id="documents_retrun_inside_division_retrunController_form-group_tb-docrt_details-message-memo">
                                                    <page id="documents_retrun_inside_division_retrunController_page"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9">
                                                                <input class="mt-2 form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_government"
                                                            ...
                                                            <div class="col-4">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_draft"
                                                            ...
                                                            <div class="col-4">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_date"
                                                            ...
                                                            <div class="col-10">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_topic"
                                                                    name="docrtdt_topic" type="text" value="<?php echo e($document_retrun_inside_detail->docrtdt_topic); ?>">
                                                            </div>
                                                            <!-- // -->
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_retrun_inside_division_retrunController_docrtdt_podium" class="form-control" rows="25" cols="75"name="docrtdt_podium"><?php echo e($document_retrun_inside_detail->docrtdt_podium); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
                                                    ...
                                                    <div class="flex items-center justify-center mt-20">
                                                        <button type="button"
                                                            id="documents_retrun_inside_division_retrunController_bt_preview"
                                                        ...
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['onclick' => 'submitForm(this);','id' => 'documents_retrun_inside_division_retrunController_bt_respond','disabled' => true]]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['onclick' => 'submitForm(this);','id' => 'documents_retrun_inside_division_retrunController_bt_respond','disabled' => true]); ?>
...
<?php endif; ?>
                                                ...
                                                <!-- ตราครุฑ -->
                                                <div class="form-group"
                                                    id="documents_retrun_inside_division_retrunController_form-group_tb-docrt_details-garuda">
                                                    <page id="documents_retrun_inside_division_retrunController_page"
                                                        class="items-center block p-24 mx-auto bg-white shadow-2xl">
                                                        <div class="row">
                                                            <div class="col-3 pt-14">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_draft-garuda"
                                                            ...
                                                            <div class="col-4 pt-14">
                                                                   <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_government-garuda"
                                                            ...
                                                            <div class="col-3">
                                                                <input class="mt-3 form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_date-garuda"
                                                            ...
                                                            <div class="col-10">
                                                                <input class="form-control form-control-border"
                                                                    id="documents_retrun_inside_division_retrunController_docrtdt_topic-garuda"
                                                                    name="docrtdt_topic_garuda" type="text" value="<?php echo e($document_retrun_inside_detail->docrtdt_topic); ?>">
                                                            </div>   
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_retrun_inside_division_retrunController_docrtdt_podium-garuda" class="form-control" rows="25" cols="75" name="docrtdt_podium_garuda"><?php echo e($document_retrun_inside_detail->docrtdt_podium); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
                                                    ...
                                                    <div class="flex items-center justify-center mt-20">
                                                        <button type="button"
                                                            id="documents_retrun_inside_division_retrunController_bt_preview-garuda"
                                                            class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-900 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:shadow-outline-blue disabled:opacity-25">
                                                            <?php echo e(__('แสดงตัวอย่าง')); ?>

                                                        </button>
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['onclick' => 'submitForm(this);','id' => 'documents_retrun_inside_division_retrunController_bt_respond-garuda','disabled' => true]]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['onclick' => 'submitForm(this);','id' => 'documents_retrun_inside_division_retrunController_bt_respond-garuda','disabled' => true]); ?>
                                                            <?php echo e(__('ตอบกลับอีกครั้ง')); ?>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="bg-indigo-300 modal-header">
                    ...
                    <button type="button"
                        id="documents_retrun_inside_division_retrunController_close-modal-preview">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="col-12">
                        <iframe id="documents_retrun_inside_division_retrunController_pdf_preview" frameborder="0" height="800px"
                            width="100%">
                        </iframe>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_retrun_inside_division_retrun/detail.blade.php ENDPATH**/ ?>