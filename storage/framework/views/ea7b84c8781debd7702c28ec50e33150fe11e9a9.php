            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-primary">เอกสารรับเข้าภายนอก (นายก)</div>
                        <div class="card-body table-responsive">
                            <table id="example1" class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $documents_admission_minister_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(url('/documents_admission_minister_all/detail/'.$row->doc_id)).'']]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(url('/documents_admission_minister_all/detail/'.$row->doc_id)).'']); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite/resources/views/member/documents_admission_minister_all/index.blade.php ENDPATH**/ ?>