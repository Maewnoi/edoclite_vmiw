...
<?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_admission_jurisprudence_understand')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                            required name="sub3_sealid" id="documents_admission_jurisprudenceController_sub3_sealid">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group hide" id="documents_admission_jurisprudenceController_form-group_sub3_note">
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
