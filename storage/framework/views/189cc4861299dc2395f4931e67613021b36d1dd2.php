...
} elseif ($_instance->childHasBeenRendered('4GF4E59')) {
    $componentId = $_instance->getRenderedChildComponentId('4GF4E59');
    $componentTag = $_instance->getRenderedChildComponentTagName('4GF4E59');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4GF4E59');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('4GF4E59', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
