...
<?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('documents_admission_group_takedown')); ?>" method="post"
...
<?php endif; ?>
                                            <div class="form-group">
                                                <input type="range" name="seal_point" class="form-range" min="10" value="100"
                                                    max="160" step="1">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
...
<?php endif; ?>
                                                        <select
                                                            class="form-control select2bs4 <?php $__errorArgs = ['sub_recnum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            <optgroup label="เลขที่จองไว้">
                                                                ...
                                                                <option
                                                                    value="<?php echo e($row_reserved_numbers->reserve_number); ?>">
                                                            ...
                                                            <optgroup label="เลขที่หลุดจอง">
                                                                ...
                                                                <option
                                                                    value="<?php echo e($row_dropped_numbers->reserve_number); ?>">
                                                        ...
                                                        <!-- <input type="text" name="sub_recnum"
                                                            class="form-control <?php $__errorArgs = ['sub_recnum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                                        <input type="date" name="sub_date" value="<?php echo e(date('Y-m-d')); ?>"
                                                            class="form-control <?php $__errorArgs = ['sub_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                                        <input type="time" name="sub_time" value="<?php echo e(date('H:i')); ?>"
                                                            class="form-control <?php $__errorArgs = ['sub_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\edoclite-lei\resources\views/member/documents_admission_group_all/detail.blade.php ENDPATH**/ ?>