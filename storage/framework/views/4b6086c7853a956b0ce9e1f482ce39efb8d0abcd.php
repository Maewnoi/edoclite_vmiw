...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo'); ?> 
        <img src="<?php echo e(asset('/image/icon.jpg')); ?>" class="brand-image img-circle elevation-3" width="100"
                height="100">
         <?php $__env->endSlot(); ?>

        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                <?php echo e(__('โปรดยืนยันการเข้าถึงบัญชีของคุณโดยป้อนรหัสการตรวจสอบที่ได้รับจากแอปพลิเคชันตรวจสอบสิทธิ์ของคุณ.')); ?>

            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                <?php echo e(__('โปรดยืนยันการเข้าถึงบัญชีของคุณโดยป้อนหนึ่งในรหัสกู้คืนฉุกเฉินของคุณ.')); ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <button type="button" class="text-sm text-gray-600 hover:text-gray-900 underline cursor-pointer"
                                    ...
                                    ">
                        <?php echo e(__('ใช้รหัสยืนยันตัวตน')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\edoclite-lei\resources\views/auth/two-factor-challenge.blade.php ENDPATH**/ ?>