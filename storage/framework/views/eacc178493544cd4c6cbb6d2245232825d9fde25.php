            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="card shadow">
                            <div class="card-header">
                                <h5 class="card-title">การจองเลข</h5>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                                    </button>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <input type="hidden"
                                    id="member_dashboard_input_documents_admission_all_waiting_count_level_4"
                                    value="<?php echo e($document_admission_all_waiting_count); ?>" class="form-control">
                                <input type="hidden"
                                    id="member_dashboard_input_documents_admission_all_success_count_level_4"
                                    value="<?php echo e($document_admission_all_success_count); ?>" class="form-control">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <input type="hidden"
                                    id="member_dashboard_input_documents_department_all_waiting_count_level_5"
                                    value="<?php echo e($document_admission_department_all_count_0); ?>" class="form-control">
                                <input type="hidden"
                                    id="member_dashboard_input_documents_department_all_success_count_level_5"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-primary"><i class="nav-icon fas fa-file-signature"></i>
                        สร้างเอกสารใหม่
                    </h4>
