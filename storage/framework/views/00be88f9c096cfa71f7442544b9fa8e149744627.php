...
<?php endif; ?>
                            ...
                            <?php if($document_detail->sub3_status == '0'): ?>
                                <form action="<?php echo e(route('documents_admission_department_inside_retrun_understand')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_admission_department_inside_retrun/detail.blade.php ENDPATH**/ ?>