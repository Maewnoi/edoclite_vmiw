                ...
                <div class="col-md-12">
                    ...
                    <div class="border shadow card border-info">
                        <div class="card-header bg-secondary">
                            <div class="clearfix">
                            เอกสารดำเนินการเรียบร้อย รอสารบรรกองลงรับ
                                <div class="float-right mt-1 ml-3 spinner-grow spinner-grow-sm text-warning" role="status" id="processingIndicator_1"> 
                                    <span class="sr-only">Loading...</span>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/edoclite_vmiw/resources/views/member/documents_pending/index.blade.php ENDPATH**/ ?>