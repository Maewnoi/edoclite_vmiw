...
class reserve_number_delivery_inside_allController extends Controller
{
    ...
    public function index(){
        if(Auth::user()->level=='6'){
            ...
            ->where('arn_template','delivery_inside')
            ->first();
            return view('member.reserve_number_delivery_inside_all.index',compact('reserve_delivery_inside_numberS','check_auto_reserve_number'));
