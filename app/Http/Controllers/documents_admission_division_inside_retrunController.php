...
class documents_admission_division_inside_retrunController extends Controller
{
    //
    ...
    public function index(){
        if(Auth::user()->level=='4'){
            ...
            // ->get();
            return view('member.documents_admission_division_inside_retrun.index');
        }else{
    ...
    public function detail($id){
        if(Auth::user()->level=='4'){
            ...
            return view('member.documents_admission_division_inside_retrun.detail',compact('document_detail','userS_8','userS_2'));
        }else{
            return redirect('member_dashboard')->with('error','คุณไม่มีสิทธิ์เข้าเมนูนี้ในระบบ !');
        }
    }
