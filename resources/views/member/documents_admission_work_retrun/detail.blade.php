                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_admission_work_retrunController_sub3d_podium" class="form-control" rows="25" cols="75"name="sub3d_podium">{{$document_detail->sub3d_podium}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <page id="documents_admission_work_retrunController_page"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_admission_work_retrunController_sub3d_podium-garuda" class="form-control" rows="25" cols="75" name="sub3d_podium_garuda">{{$document_detail->sub3d_podium}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
