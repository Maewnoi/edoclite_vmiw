                    ...
                    <div class="border shadow card border-info">
                        ...
                        <div class="card-body table-responsive">
                            <table id="example1" class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($reserve_announce_numberS as $row)
                                    <tr>
                                        <th>{{$loop->index+1}}</th>
                                        ...
                                        <div class="modal-dialog modal-l">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('cancel_reserve_number_announce_all')}}" method="post">
                                                        @csrf
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="reserve_number"
                                                            min="{{functionController::funtion_documents_doc_recnum_announce_plus(Auth::user()->site_id)}}"
                                                            value="{{functionController::funtion_documents_doc_recnum_announce_plus(Auth::user()->site_id)}}"
