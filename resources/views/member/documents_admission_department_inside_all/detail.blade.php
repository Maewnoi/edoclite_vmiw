                ...
                <div class="col-md-12">
                    ...
                    <div class="border shadow card border-info">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('documents_admission_department_inside_takedown')}}" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control select2bs4 @error('sign_goup_1_inside') is-invalid @enderror"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea name="seal_detail_0_inside" rows="4" cols="50"
                                                            class="form-control @error('seal_detail_0_inside') is-invalid @enderror"></textarea>
                                                        @error('seal_detail_0_inside')
                                                        <div class="my-2">
                                                            <p class="mt-2 text-sm text-red-600">
                                                                {{$message}}</p>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="seal_pos_0_inside"
                                                            value="{{Auth::user()->pos}}"
                                                            class="form-control @error('seal_pos_0_inside') is-invalid @enderror"
                                                            required>
                                                        @error('seal_pos_0_inside')
                                                        <div class="my-2">
                                                            <p class="mt-2 text-sm text-red-600">
                                                                {{$message}}</p>
                                                        </div>
