                ...
                <div class="col-md-12">
                    ...
                    <div class="border shadow card border-info">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('documents_admission_division_takedown')}}" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <div class="hide"
                                                            ...
                                                            <hr><select
                                                                class="form-control select2bs4 @error('sign_goup_4') is-invalid @enderror"
                                                                name="sign_goup_4"
                                                        ...
                                                        <!-- <div class="hide"
                                                            ...
                                                            <hr><select
                                                                class="form-control select2bs4 @error('sign_goup_5') is-invalid @enderror"
                                                                name="sign_goup_5"
                                                        ...
                                                        <!-- <div class="hide"
                                                            ...
                                                            <hr><select
                                                                class="form-control select2bs4 @error('sign_goup_6') is-invalid @enderror"
                                                                name="sign_goup_6"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"
                                                        ...
                                                        <button id='documents_admission_division_allController_selected_multiple_sub2_recid-select-all' class="h-10 px-5 m-2 text-sm text-purple-100 transition-colors duration-150 bg-purple-600 rounded-lg focus:shadow-outline hover:bg-purple-700">
                                                        เลือกทั้งหมด
                                                        </button>
                                                    ...
                                                    <div class="form-group"
                                                        ...
                                                        <button id='documents_admission_division_allController_selected_multiple_sub2_recid_cottons-select-all' class="h-10 px-5 m-2 text-sm text-purple-100 transition-colors duration-150 bg-purple-600 rounded-lg focus:shadow-outline hover:bg-purple-700">
                                                        เลือกทั้งหมด
                                                        </button>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea name="seal_detail_1" rows="4" cols="50"
                                                            class="form-control @error('seal_detail_1') is-invalid @enderror"></textarea>
                                                        @error('seal_detail_1')
                                                        <div class="my-2">
                                                            <p class="mt-2 text-sm text-red-600">
                                                                {{$message}}</p>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="seal_pos_1"
                                                            value="{{Auth::user()->pos}}"
                                                            class="form-control @error('seal_pos_1') is-invalid @enderror"
                                                            required>
                                                        @error('seal_pos_1')
                                                        <div class="my-2">
                                                            <p class="mt-2 text-sm text-red-600">
