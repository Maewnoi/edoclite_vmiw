                ...
                <div class="col-md-12">
                    <div class="border shadow card border-info">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('documents_retrun_inside_department_retrun_respond')}}" method="post"
                                                ...
                                                <div class="form-group"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_retrun_inside_department_retrunController_docrtdt_podium" class="form-control" rows="25" cols="75"name="docrtdt_podium">{{$document_retrun_inside_detail->docrtdt_podium}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
                                                    ...
                                                    <div class="flex items-center justify-center mt-20">
                                                        ...
                                                        <x-jet-button onclick="submitForm(this);"
                                                            id="documents_retrun_inside_department_retrunController_bt_respond"
                                                            disabled>
                                                            {{ __('ตอบกลับอีกครั้ง') }}
                                                        </x-jet-button>
                                                    </div>
                                                ...
                                                <div class="form-group"
                                                    ...
                                                    <page id="documents_retrun_inside_department_retrunController_page"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mt-3 mb-14">
                                                                    <textarea id="documents_retrun_inside_department_retrunController_docrtdt_podium-garuda" class="form-control" rows="25" cols="75" name="docrtdt_podium_garuda">{{$document_retrun_inside_detail->docrtdt_podium}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </page>
                                                    ...
                                                    <div class="flex items-center justify-center mt-20">
                                                        ...
                                                        <x-jet-button onclick="submitForm(this);"
                                                            id="documents_retrun_inside_department_retrunController_bt_respond-garuda"
                                                            disabled>
                                                            {{ __('ตอบกลับอีกครั้ง') }}
                                                        </x-jet-button>
                                                    </div>
