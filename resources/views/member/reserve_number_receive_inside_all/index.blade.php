                    ...
                    <div class="border shadow card border-info">
                        ...
                        <div class="card-body table-responsive">
                            <table id="example1" class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($reserve_inside_numberS as $row)
                                    <tr>
                                        <th>{{$loop->index+1}}</th>
                                        ...
                                        <td>
                                            {{ functionController::funtion_groupmem_name($row->reserve_group) }}
                                        </td>
                                        <td>
                                        ...
                                        <div class="modal-dialog modal-l">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('cancel_reserve_number_receive_inside_all')}}"
                                                        method="post">
                                                        @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="@if($check_auto_reserve_number) @else {{ 'hide' }} @endif " id="auto_reserve_number_form_card">
                                                ...
                                                <input type="hidden" id="auto_reserve_number_arn_template" value="receive_inside">
