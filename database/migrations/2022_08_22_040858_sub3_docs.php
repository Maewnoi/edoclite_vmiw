...
class Sub3Docs extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('sub3_docs', function (Blueprint $table) {
            ...
            $table->enum('sub3_status', array('0', '1', '2'))->default('0');
            ...
            $table->string('sub3_sealdate_0')->nullable();
            $table->string('sub3_sealid_0')->nullable();

            $table->string('sub3_sealdetail_1')->nullable();
            $table->string('sub3_sealnote_1')->nullable();
            $table->string('sub3_sealpos_1')->nullable();
            $table->string('sub3_sealdate_1')->nullable();
            $table->string('sub3_sealid_1')->nullable();
