...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('level', ['0', '1', '2', '3', '4', '5', '6', '7', '8'])->comment('0=แอดมิน\1=นายก,รองนายก\2=ปลัด,รองปลัด\3=สารบรรณกลาง\4=หัวหน้ากอง\5=หัวหน้าฝ่าย\6=สารบรรณกอง\7=งาน\8=หน้าห้องนายกและหน้าห้องปลัด'); //สิทธิ์การเข้าถึง  0=แอดมิน\1=นายก\2=รองนายก,ปลัด,รองปลัด\3=สารบรรณกลาง\4=หัวหน้ากอง\5=หัวหน้าฝ่าย\6=สารบรรณกอง\7=งาน
            $table->rememberToken();
